...
#    pick a random card for computer
#    pick a random card for player
#    check who won (higher card) ? player +1 , or computer +1 or draw
#    if score of player/computer == 10 exit loop
# print winner
